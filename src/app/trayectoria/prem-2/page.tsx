...
export default async function PremiosPage2() {
  const bucket = 'prem-2'
  ...
  return (
    <Container maxWidth="xl">
      <Box sx={{ width: '100%' }} padding={5}>
        <Typography variant="h4">Premios y Distinciones Pagina 2</Typography>
